                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                <li><a class="category" data-type="<?= $c2['c2'] ?>"
                                                        value=" <?= $c2['c2'] ?>"><?= $c2['namacategory']; ?>
                                ...
                                <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <div class="shop__sidebar__brand">
                                            ...
                                            <ul>
                                                <li><a class="brands" value="<?= $br['id']; ?>"
                                                        data-type="<?= $br['id']; ?>"><?= $br['namabrands']; ?></a>
                                                </li>
                                            </ul>
                                            <?php endforeach; ?>
                                        </div>
                        ...
                        <div class="product__item">
                            <div class="product__item__pic set-bg"
                                ...
                                <ul class="product__hover">
                                    ...
                                    <li><a href="<?= base_url('produk/' . $pr['slug']); ?>"><img
                                                src="<?= base_url('img/icon/search.png') ?>" alt=""></a></li>
                                </ul>
                            </div>
