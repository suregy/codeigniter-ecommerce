...
<section class="shop-details">
    ...
    <div class="product__details__pic">
        <input type="hidden" name="idprod" id="idprod" value="<?= $detail['id']; ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $i === 1 ? 'active' : '' ?>" data-toggle="tab"
                                ...
                                <div class="product__thumb__pic set-bg"
                                    data-setbg="<?= base_url('images/products/' . $img['file']);  ?>">
                                </div>
                            </a>
                        </li>
                        <?php endforeach; ?>
                ...
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__cart__option">
                            ...
                            <a href="<?= base_url('buy/' . $detail['id']); ?>" class="primary-btn addCart">add to
                                cart</a>
                        </div>
