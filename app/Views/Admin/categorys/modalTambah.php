  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="form-group row fcat2" style="display: none;">
        <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Tambah Kategori 2</label>
        <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm-1" name="c2" id="c2" placeholder="Kode c2">
            <div class="invalid-feedback errc2"></div>
        </div>
        <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm-1" name="nmc2" id="nmc2" placeholder="Nama kategori 2">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" name="nmc3" id="nmc3" placeholder="Nama kategori">
        ...
        $('.addCat1').click(function(e){
          ...
          $.ajax({
            ...
            success: function(response){
                $('.tampilModalcat').html(response.data).show(); //show digunakan karena display none
