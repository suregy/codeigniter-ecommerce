...
<div class="row">
    <div class="col-lg">
        ...
        <div class="mb-3">
            ...
            <button class="btn btn-default btn-sm tambahDataBanyak"> <i class="fas fa-plus-circle"></i> Tambah Data Banyak</button>
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(cmb1, function(i, item) {
                        option += '<option value="'+item.c1+'" '+ (response.value.c1 == item.c1 ? ' selected ' : '') +' >'+item.namacategory+'</option>';
                    });
                    $('#cmbcat1').html(option);
                    ...
                    $.each(cmb2, function(i, item) {
                        option2 += '<option value="'+item.c2+'" '+ (response.value.c2 == item.c2 ? ' selected ' : '') +' >'+item.namacategory+'</option>';
                    });
